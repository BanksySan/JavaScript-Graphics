import { createProgram, fetchShaderTexts, initialiseMesh } from '../../helpers/webglHelpers.js';

const SHADER_TEXTS_PROMISE = fetchShaderTexts('./hello-world.vert.glsl', './hello-world.frag.glsl');
