...
SVG.setAttribute('viewBox', `${VIEW_BOX.x} ${VIEW_BOX.y} ${VIEW_BOX.width} ${VIEW_BOX.height}`);
...
SVG.addEventListener('mousedown', function (event) {
  ...
  const clickPoint = (new DOMPoint(event.clientX, event.clientY)).matrixTransform(inverseContextMatrix);
